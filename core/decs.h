...
#define ZLOOP KLOOP JLOOP ILOOP
#define ZLOOPALL KLOOPALL JLOOPALL ILOOPALL
// Transpose loops for forward-index output
#define ZLOOP_OUT ILOOP JLOOP KLOOP
#define ZLOOP_TRANSPOSE ILOOPALL JLOOPALL KLOOPALL
